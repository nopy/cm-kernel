...
#ifndef CONFIG_MSM_BUS_SCALING
	pm_qos_add_request(&mfd->pm_qos_req, PM_QOS_SYSTEM_BUS_FREQ,
...
#ifdef CONFIG_HAS_EARLYSUSPEND
	mfd->early_suspend.level = EARLY_SUSPEND_LEVEL_DISABLE_FB;
	mfd->early_suspend.suspend = mddi_early_suspend;
	mfd->early_suspend.resume = mddi_early_resume;
